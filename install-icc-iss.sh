...
# Compilers
COMPONENTS_ICC="intel-icc-32bit-meta-linux-2019.0-113__noarch;intel-icc-64bit-meta-linux-2019.0-113__noarch"
...
PRODUCT_NAME="system_studio_2019"
INSTALLER_TARBALL="${PRODUCT_NAME}.tar.gz"
INSTALLER_URL="https://registrationcenter-download.intel.com/akdlm/irc_nas/13769/${INSTALLER_TARBALL}"
...
while [ $attempt -le 3 ]; do
    ...
    if [ ! -e "${DESTINATION}/${PRODUCT_NAME}/bin/compilervars.sh" ]; then
...
echo "export INTEL_INSTALL_PATH=\"${DESTINATION}/${PRODUCT_NAME}\"" >> ~/.bashrc-intel
